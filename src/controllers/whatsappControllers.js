...
const whatsappservice = require("../services/whatsappService"); //importamos el servicio
const samples = require("../shared/sampleMiodels"); //importamos las funcionesd shared para devolvr un contenido
